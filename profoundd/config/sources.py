...
NEWS_SOURCES = [
    ...
    # --- US News ---
    {"name": "Washington Post", "url": "https://feeds.washingtonpost.com/rss/national", "category": "news", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
    {"name": "ABC News", "url": "https://abcnews.go.com/abcnews/topstories", "category": "news", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
    ...
    # --- Business News ---
    {"name": "CNBC", "url": "https://search.cnbc.com/rs/search/combinedcms/view.xml?partnerId=wrss01&id=100003114", "category": "news", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
    {"name": "Bloomberg", "url": "https://feeds.bloomberg.com/markets/news.rss", "category": "news", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
...
MEDICAL_SOURCES = [
    {"name": "WHO News", "url": "https://www.who.int/rss-feeds/news-english.xml", "category": "medical", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
    {"name": "Medical News Today", "url": "https://www.medicalnewstoday.com/newsfeeds/rss", "category": "medical", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
    {"name": "The Lancet", "url": "https://www.thelancet.com/rssfeed/lancet_current.xml", "category": "medical", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
    {"name": "NEJM", "url": "https://www.nejm.org/action/showFeed?jc=nejm&type=etoc&feed=rss", "category": "medical", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
    {"name": "WebMD Health", "url": "https://rssfeeds.webmd.com/rss/rss.aspx?RSSSource=RSS_PUBLIC", "category": "medical", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
...
LEGAL_SOURCES = [
    ...
    {"name": "Reuters Legal", "url": "https://www.reuters.com/legal/rss", "category": "legal", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
...
FINANCE_SOURCES = [
    # --- Finance ---
    {"name": "Financial Times", "url": "https://www.ft.com/rss/home", "category": "finance", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
    {"name": "MarketWatch", "url": "https://feeds.marketwatch.com/marketwatch/topstories/", "category": "finance", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
    {"name": "Yahoo Finance", "url": "https://finance.yahoo.com/news/rssindex", "category": "finance", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
    ...
    {"name": "Wall Street Journal", "url": "https://feeds.a.dj.com/rss/RSSMarketsMain.xml", "category": "finance", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
...
POLITICS_SOURCES = [
    # --- Politics & Policy ---
    {"name": "Politico", "url": "https://www.politico.com/rss/politicopicks.xml", "category": "politics", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
    {"name": "The Hill", "url": "https://thehill.com/feed/", "category": "politics", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
...
EPSTEIN_SOURCES = [
    ...
    {"name": "Insider", "url": "https://www.businessinsider.com/sai/rss", "category": "epstein-files", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
    {"name": "Fox News", "url": "https://moxie.foxnews.com/google-publisher/latest.xml", "category": "epstein-files", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
...
CHARLIE_KIRK_SOURCES = [
    ...
    {"name": "Fox News", "url": "https://moxie.foxnews.com/google-publisher/latest.xml", "category": "charlie-kirk", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
    {"name": "New York Post", "url": "https://nypost.com/feed/", "category": "charlie-kirk", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
    {"name": "Newsmax", "url": "https://www.newsmax.com/rss/Newsfront/1/", "category": "charlie-kirk", "credibility": 3, "feed_type": "rss", "sponsors": "Pfizer"},
